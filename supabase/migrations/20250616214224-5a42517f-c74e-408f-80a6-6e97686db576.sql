...
-- Fix the generate_client_portal_access function to use standard base64 encoding instead of base64url
...
BEGIN
  ...
  -- Generate secure token using standard base64 encoding (not base64url)
  v_token := encode(
