...
-- Fix the generate_client_portal_access function to work without gen_random_bytes
...
BEGIN
  ...
  -- Generate secure token using available functions
  v_token := encode(
...
-- Update estimates to have proper client_id values based on their job relationships
