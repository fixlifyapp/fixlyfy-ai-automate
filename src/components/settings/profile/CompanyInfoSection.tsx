    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-gray-50 border rounded-lg text-xs">
        <div className="font-mono">
          <div><strong>Current Company Name:</strong> "{localSettings.company_name || 'EMPTY'}"</div>
          <div><strong>Has Changes:</strong> {hasChanges ? 'Yes' : 'No'}</div>
          <div><strong>Generated Email:</strong> {getAutoGeneratedEmail()}</div>
        </div>
      </div>
