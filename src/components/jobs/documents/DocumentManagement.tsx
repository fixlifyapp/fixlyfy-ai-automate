    ...
    if (estimates) {
      estimates.forEach(estimate => {
        docs.push({
          ...
          client_name: typeof estimate.client === 'string' ? estimate.client : estimate.client?.name || 'Unknown Client',
    ...
    if (invoices) {
      invoices.forEach(invoice => {
        docs.push({
          ...
          client_name: typeof invoice.client === 'string' ? invoice.client : invoice.client?.name || 'Unknown Client',
