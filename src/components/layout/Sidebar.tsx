        ...
        <div className="px-3 py-2">
          <div className="mb-6 px-4 py-2">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold bg-gradient-primary bg-clip-text text-transparent tracking-tight transform hover:scale-105 transition-transform duration-300" 
                  style={{
              ...
              <div className="relative">
                <div 
                  className="w-8 h-8 bg-gradient-primary rounded-lg shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-300"
                  style={{
                ...
                <div 
                  className="absolute -top-1 -right-1 w-2 h-2 bg-gradient-primary rounded-full opacity-60"
                  style={{
