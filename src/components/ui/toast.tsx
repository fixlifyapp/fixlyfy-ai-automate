...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-[15%] sm:right-0 sm:left-0 sm:mx-auto sm:max-w-[420px]",
      className
    )}
    {...props}
  />
...
// Toast timer indicator
const ToastTimer = React.forwardRef<
  HTMLDivElement, 
  { duration?: number }
>(({ duration = 5000 }, ref) => (
