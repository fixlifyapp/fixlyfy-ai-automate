...
export const EmailInterfaceHeader = ({
  ...
  return <div className="p-4 border-b border-fixlyfy-border bg-gradient-to-r from-fixlyfy/5 to-fixlyfy-light/5">
      ...
      <div className="relative flex-1">
        ...
        <Input placeholder="Search conversations..." value={searchTerm} onChange={e => onSearchChange(e.target.value)} className="pl-10 border-fixlyfy-border focus:ring-2 focus:ring-fixlyfy/20 focus:border-fixlyfy" />
      </div>
