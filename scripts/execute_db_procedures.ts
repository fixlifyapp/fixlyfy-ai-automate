...
// This script will execute the stored procedures SQL
// Run this script after deploying to ensure the procedures are created
...
async function executeProcedures() {
  try {
    ...
    console.log('Database procedures executed successfully');
    return true;
  } catch (error) {
    console.error('Error executing procedures:', error);
    return false;
...
export default executeProcedures;
